...
public class TiDbConnector extends BaseSourceConnector {
    ...
    public List<TableId> getMatchingCollections(Configuration config) {
        // Requires a connection to TiDB's SQL endpoint that will come with snapshot support
        throw new UnsupportedOperationException("Listing matching collections is not supported by the TiDB connector yet");
    }
}
